...
class OutSideCustomShape extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path_1.quadraticBezierTo(size.width * 0.5043833, size.height * 0.9995286,
        size.width * -0.0004500, size.height * 0.6429571);
    path_1.quadraticBezierTo(
        size.width * -0.0004500, size.height * 0.4998143, 0, 0);
    path_1.close();
