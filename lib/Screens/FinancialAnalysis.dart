  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : SingleChildScrollView(  // جعل الصفحة قابلة للتمرير
        child: Column(
          children: [
            ...
            // عرض المصاريف والمداخيل أسفل الصفحة مع تأثير الخطوط
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Column(
                ...
                children: [
                  ...
                  if (expenses.isNotEmpty)
                    ListView.builder(
                      shrinkWrap: true,  // لتقليص حجم القائمة
                      physics: NeverScrollableScrollPhysics(),  // تعطيل التمرير هنا
